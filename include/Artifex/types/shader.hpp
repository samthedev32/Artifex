...
private:
  ...
  unsigned int get(const std::string &n);

public:
  explicit Shader(unsigned int id = 0);
  ...
  void set(const std::string &n, unsigned int x, unsigned int y);
  ...
  void set(const std::string &n, unsigned int x, unsigned int y, unsigned int z);
  ...
  void set(const std::string &n, unsigned int x, unsigned int y, unsigned int z, unsigned int w);
  void set(const std::string &n, float x, float y, float z, float w);
  void set(const std::string &n, double x, double y, double z, double w);

  // Vectors

  template <vec_t D, typename T> void set(const std::string &n, vec<D, T> vec);

  // Matrices

  template <mat_t R, mat_t C, typename T> void set(const std::string &n, mat<R, C, T> mat);
};
