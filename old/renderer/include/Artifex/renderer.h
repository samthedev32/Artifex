...
#include <Artifex/color4.h>
#include <Artifex/id.h>
...
typedef void (*axRendererDraw_t)(int);
...
// Load Mesh
struct axMesh axRendererLoadMesh(axRenderer renderer, const vec2* vertices, long v_size, const unsigned int* indices, long i_size);
